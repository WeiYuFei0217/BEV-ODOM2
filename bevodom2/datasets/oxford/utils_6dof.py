"""
Oxford RobotCar dataset utility functions (6DoF version).

Provides 6DoF pose reading, coordinate transformation, and point cloud operations.
Unlike utils.py, RPY2Rot uses the full 3D rotation matrix instead of a simplified
2D approximation.
"""
...
def RPY2Rot(x, y, z, roll, pitch, yaw):
    """Convert translation and RPY Euler angles to a 4x4 homogeneous matrix (full 3D)."""
    R = [
